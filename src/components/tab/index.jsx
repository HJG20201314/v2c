...
import { handleTextOverTitle } from '@/hooks/tools'
          ...
          <div class={`${prefixCls}_main ${prefixCls}_main-${this.type}`}>
              ...
              {tabs.map(item =>
                <li class={ ` ${this.value === item[tabProps.name] ? `${prefixCls}_main-${this.type}-is-active` : ''}` }
                  ...
                  onMouseover={handleTextOverTitle}
